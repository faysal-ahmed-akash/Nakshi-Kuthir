...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.0.3&nocache=6257057430ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="tbl_recent_favorite.php?db=nakshikuthir&amp;table=product">`nakshikuthir`.`product`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=nakshikuthir&amp;table=logintb">`nakshikuthir`.`logintb`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=member">`libraryassistant`.`member`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=return_book">`libraryassistant`.`return_book`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=issue_book">`libraryassistant`.`issue_book`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=book">`libraryassistant`.`book`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=librarian">`libraryassistant`.`librarian`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=admin_table">`libraryassistant`.`admin_table`</a></li><li class="warp_link"><a href="tbl_recent_favorite.php?db=libraryassistant&amp;table=ADMIN_TABLE">`libraryassistant`.`ADMIN_TABLE`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<input type="hidden" name="token" value="6f40533976255f4b3960545627286658">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="libraryassistant" targettable="librarian">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `librarian` ADD PRIMARY KEY(`LibrarianId`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="libraryassistant" targettable="member">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `member`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="libraryassistant" targettable="book">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `libraryassistant`.`book` ( `BookId` VARCHAR(50) NOT NULL ,  `ISBN` INT(50) NOT NULL ,  `BookName` VARCHAR(50) NOT NULL ,  `BookPublisher` VARCHAR(50) NOT NULL ,  `BookEdition` VARCHAR(50) NOT NULL ,  `Stock` INT(50) NOT NULL ,  `Issued` INT(50) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="libraryassistant" targettable="book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `book` ADD PRIMARY KEY(`BookId`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="libraryassistant" targettable="book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `member`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="libraryassistant" targettable="issue_book">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `libraryassistant`.`issue_book` ( `IssueId` VARCHAR(50) NOT NULL ,  `BookId` VARCHAR(50) NOT NULL ,  `MemberId` VARCHAR(50) NOT NULL ,  `IssuedDate` VARCHAR(50) NOT NULL ,  `ExpiryDate` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`IssueId`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="libraryassistant" targettable="issue_book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `issue_book`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="libraryassistant" targettable="return_book">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `libraryassistant`.`return_book` ( `ReturnId` VARCHAR(50) NOT NULL ,  `BookId` VARCHAR(50) NOT NULL ,  `MemberId` VARCHAR(50) NOT NULL ,  `ReturnDate` VARCHAR(50) NOT NULL ,  `RatingModification` FLOAT(50) NOT NULL ,  `Fine` FLOAT(50) NOT NULL ,    PRIMARY KEY  (`ReturnId`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="libraryassistant" targettable="member">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `return_book`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="libraryassistant" targettable="issue_book">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `member`</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="nakshikuthir" targettable="logintb">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nakshikuthir`.`logintb` ( `username` VARCHAR(50) NOT NULL ,  `name` VARCHAR(50) NOT NULL ,  `gender` VARCHAR(50) NOT NULL ,  `address` VARCHAR(50) NOT NULL ,  `phone` VARCHAR(50) NOT NULL ,  `email` VARCHAR(50) NOT NULL ,  `password` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`username`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nakshikuthir" targettable="logintb">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `logintb`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nakshikuthir" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `nakshikuthir`.`product` ( `id` INT(50) NOT NULL ,  `name` VARCHAR(50) NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="nakshikuthir" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `product` (`id`, `name`) VALUES (&#039;1&#039;, &#039;Blue Shirt&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nakshikuthir" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `product` (`id`, `name`) VALUES (&#039;2&#039;, &#039;Men\&#039;s Jeans Pant &#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="nakshikuthir" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `product` (`id`, `name`) VALUES (&#039;3&#039;, &#039;Polo T-shirt&#039;);</span>
                        </div>
